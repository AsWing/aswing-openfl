...
// mark as invalid!
        ...
        while (info.parent != null) {
            var newParent:FHTreeStateNode = cast(info.parent.getParent(), FHTreeStateNode);
...
// to an entirely new root.
            ...
            (changedPath != null && changedPath.getPathCount() <= 1)))) {
                ...
                var parent:FHTreeStateNode = cast(changedNode.getParent(), FHTreeStateNode);
 ...
 */
    ...
    private function getMapping(path:TreePath):FHTreeStateNode {
        return cast(treePathMapping.get(path), FHTreeStateNode);
    }
...
// Check all the parent paths, until a match is found.
            ...
            if (tempStacks.size() == 0) {
                ...
                paths = cast(tempStacks.pop(), Stack);
            }
